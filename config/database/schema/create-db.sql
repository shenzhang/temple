...
CREATE INDEX I_MEMBER__CHINESS_LAST_NAME__CHINESS_FIRST_NAME ON T_MEMBER(CHINESS_LAST_NAME, CHINESS_FIRST_NAME);
...
(
  MEMBER_ID NOT NULL REFERENCES T_MEMBER(ID),
